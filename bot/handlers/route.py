...
ROUTE_SELECTION = ('Выберите маршрут из списка ниже, чтобы посмотреть его '
                   'подробное описание')
START_MEDITATION = 'Начать медиацию'
ROUTE_START_POINT = 'Медиация начинается по адресу:\n{}'
MEDITATION_ENDED = ('На этом, медиация по маршруту «{}» окончена. '
...
FORM_OFFER = ('Команда фестиваля «Ничего страшного» будет рада вашему '
              'отклику! Для этого мы прикрепляем небольшую форму, заполнение '
